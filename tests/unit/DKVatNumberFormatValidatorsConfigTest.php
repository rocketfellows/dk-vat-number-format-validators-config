...
namespace rocketfellows\DKVatNumberFormatValidatorsConfig\tests\unit;
...
use rocketfellows\DKVatNumberFormatValidatorsConfig\DKVatNumberFormatValidatorsConfig;

class DKVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = DKVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = DKVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::DK(), $config->getCountry());
    }
